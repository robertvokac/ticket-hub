...
**2026-09-25 — presentation-site publishing (done).** The owner enabled Pages with GitHub Actions as
the source and saved the custom domain. Commit `c6cb7b5` triggered a successful Pages deployment from
`web/` on `develop`; <https://tickethub.robertvokac.com/> serves the presentation site over HTTPS.
The home page and screenshot asset were checked live. No more work is queued for the presentation site.
...
JavaScript. No product behavior or database schema changed.
